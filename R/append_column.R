...
#' @export
#'
append_column <- function(wb,sheet, patternCol=NULL, col, startRow = 1, endRow = NULL,dataStart,data, colNames = FALSE){
  ...
  styles <- get_styles_of_area(wb,sheet,cols = patternCol, rows = startRow:endRow)
