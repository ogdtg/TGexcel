...
#' @export
#'
create_nested_header_style <-  function(wb, sheet, vars_level1, vars_level2, nesting = "even", startRow, vars_level1_style = varname_normal_10_left, vars_level2_style= varname_normal_10_left,...){
